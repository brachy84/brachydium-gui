 ...
 */
public record TextureArea(Identifier path, Size imageSize, float u0,
    ...
    public static TextureArea fullImage(Identifier path, float width, float height) {
        return new TextureArea(path, new Size(width, height), 0, 0, 1, 1);
    }
